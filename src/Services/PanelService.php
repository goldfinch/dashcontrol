...
namespace Goldfinch\Dashpanel\Services;
...
class PanelService
{
    ...
    public static function getGitCommits($limit = 10): array | null
    {
        ...
        {
            chdir(BASE_PATH);
            exec('git log -' . $limit . ' --pretty=\'%H|-|-|%s|-|-|%an|-|-|%ae|-|-|%aD\'', $logs);
                ...
                'versions' => [
                  'first' => [
                    ...
                    'author' => $firstVersion->Author() ? [
                      'name' => $firstVersion->Author()->getName(),
                      'link' => '/admin/security/users/EditForm/field/users/item/'.$firstVersion->Author()->ID.'/edit'
                    ] : null,
                  ],
                  'last' => [
                    ...
                    'author' => $lastVersion->Author() ? [
                      ...
                      'link' => '/admin/security/users/EditForm/field/users/item/'.$lastVersion->Author()->ID.'/edit'
                    ] : null,
                  ],
                ],
                'icon' => substr($object->getIconClass(), 0, 3) === 'bi-' ? substr($object->getIconClass(), 3) : $object->getIconClass(),
